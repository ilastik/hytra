...
def test_trackletgraph():
    ...
    networkx.add_path(h._graph, [(0, 1), (1, 1), (2, 1), (3, 1)])
...
def test_computeLineagesAndPrune():
    h = hg.HypothesesGraph()
    networkx.add_path(h._graph, [(0, 0), (1, 1), (2, 2)])
    networkx.add_path(h._graph, [(1, 1), (2, 3), (3, 4)])
...
def test_computeLineagesWithMergers():
    h = hg.HypothesesGraph()
    networkx.add_path(h._graph, [(0, 0), (1, 1), (2, 2)])
    networkx.add_path(h._graph, [(0, 5), (1, 1), (2, 3), (3, 4)])
